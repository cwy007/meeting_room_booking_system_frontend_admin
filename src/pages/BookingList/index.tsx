...
import { Form, Input, Button, Table, Tag, Space, DatePicker, App, message } from "antd";
import { SearchOutlined } from "@ant-design/icons";
import type { TableProps } from "antd";
import type { RangePickerProps } from "antd/es/date-picker";
import dayjs from "dayjs";
import type { Booking, BookingListParams, BookingStatus } from "./types";
import { getBookingList, approveBooking, rejectBooking, releaseBooking } from "./services";
...
function BookingList() {
  ...
  const handleApprove = async (record: Booking) => {
    await approveBooking(record.id);
    message.success("审批通过");
    fetchData(page, pageSize, form.getFieldsValue());
  };

  const handleReject = async (record: Booking) => {
  ...
  return (
    <div>
      ...
      >
        ...
        <Form.Item name="timeRange" label="预订时间">
          <RangePicker
